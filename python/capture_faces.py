...
def parse_args():
    ...
    parser.add_argument("--samples", type=int, default=2, help="Number of face samples to capture")
...
def main():
    ...
    print("Capture 2 clear face samples. Use different angles if possible.")
