...
CONFIDENCE_THRESHOLD = float(os.environ.get("FACE_CONFIDENCE_THRESHOLD", "0.52"))
FACE_DISTANCE_THRESHOLD = float(os.environ.get("FACE_DISTANCE_THRESHOLD", "0.48"))
FACE_MATCH_MARGIN = float(os.environ.get("FACE_MATCH_MARGIN", "0.035"))
